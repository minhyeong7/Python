...
# new_Date를 인덱스로 설정
# Date 컬럼은 삭제
df=df.drop('Date', axis=1).set_index('new_Date')
print(df)
...
print(pd.Timestamp("2022-04-28"))
print()

print("-----pd.Timestamp-----")
print()
print(pd.to_datetime("2023년 12월 25일", format="%Y년 %m월 %d일"))
print(pd.to_datetime("12-12-2025 23:59:12", format="%d-%m-%Y %H:%M:%S")) # 중간에 공백

# Timestamp를 Period로 변환

dates = ['2019-01-01','2020-03-01','2021-06-03']
